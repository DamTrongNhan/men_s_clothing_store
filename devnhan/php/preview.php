    ...
    <div class="container-fluid">
        ...
        ?>
            ...
            <div class="row container__content">
                <div class="col-md-6 container__slide mb-5">
                    <div class="slider-for">
                        <div class="slider-item mb-4">
                            <img src="../admin/upload/<?php echo $productItem['productImg'] ?>" alt="" class="slide-img">
                        </div>
                ...
                <div class="col-md-6 container__info">
                    ...
                    <div class="container__info__choose row">
                        <div class="col-md-6">
                            <label for="size" class="fw-bold mb-3">Size</label>
                    ...
                    <div class="container__info__quantity mt-3">
                        <label for="" class="fw-bold mb-3">Quantity</label>
                        <div class="input-group">
                            <input type="button" value="-" class="button-minus" data-field="quantity">
                            <input type="text" value="1" disabled name="quantity" class="quantity-field text-center fw-bold" id="quantity">
...
<script src="../js/previewQuantity.js"></script>
...
<script>
    ...
    btn_buy.addEventListener('click', (e) => {
        ...
        swal({
            ...
            .then((value) => {
                loadShopingCart(id, name, price, img, size, quantity)
            });
    })
</script>
